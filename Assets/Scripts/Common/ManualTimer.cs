...
namespace Scaffold
{
	// This is an industrial strength implementation of a timer class.
	//
	// It has been used in reused in many projects and has withstood all unit
	// tests so far.
	//
	// This class is an excellent demonstration of how to write a high-quality
	// library component.
	//
	// If you are interested in writing high-quality production code,
	// understanding the techniques used in this class is a great first step.
	// Take particular note to the documentation comments--the presentation of
	// a class is as important as the code to implement it.
	...
	public class ManualTimer : IEquatable<ManualTimer>
	{
		...
		{
			return 2065618965 + duration.GetHashCode();
		}
